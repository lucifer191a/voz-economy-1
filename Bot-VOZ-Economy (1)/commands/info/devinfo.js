...
module.exports = ({
    ...
    description: "Thông tin của developer!",
    usage: "",
    category: "information",
    code: `$title[Click vào đây!;https://www.facebook.com/taihoang.yato/]
    $author[$userTag[$botOwnerID]]
    $color[RANDOM]
    $thumbnail[$userAvatar[$botOwnerID]]
    $description[Nếu bạn muốn hãy liên hệ với dev qua [link\\](https://www.facebook.com/taihoang.yato/)!]
    ...
    $addField[Trạng thái; $replaceText[$replaceText[$replaceText[$replaceText[$status[$botOwnerID];offline;Offline];online;Online];dnd;Do not disturb];idle;Idle]]
    $addField[Ngày tham gia ;$creationDate[$botOwnerID]]
    $addTimestamp
