...
module.exports = ({
    name: "invite",
    aliases: ['add'],
    description: "Thêm tôi vào server của bạn!",
    usage: "",
    category: "utility",
    code: `$description[Click [vào đây\\](https://discord.com/oauth2/authorize?client_id=$clientID&scope=bot&permissions=3728207737) để invite!]
    $color[RANDOM]`
})
